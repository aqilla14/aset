        ...
        <form action="{{ route('pengembalian.update', $pengembalian->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select
                    ...
                    <option value="baik"
                        {{ old('kondisi', $pengembalian->kondisi) == 'baik' ? 'selected' : '' }}>
                        Baik
                    </option>

                    <option value="rusak_ringan"
                        {{ old('kondisi', $pengembalian->kondisi) == 'rusak_ringan' ? 'selected' : '' }}>
                        Rusak Ringan
                    </option>

                    <option value="rusak_berat"
                        {{ old('kondisi', $pengembalian->kondisi) == 'rusak_berat' ? 'selected' : '' }}>
                        Rusak Berat
                    </option>
            ...
            <div class="mb-3">
                ...
                <textarea
                    ...
                    name="catatan"
                    rows="4"
                    placeholder="Masukkan catatan kondisi atau informasi pengembalian">{{ old('catatan', $pengembalian->catatan) }}</textarea>
